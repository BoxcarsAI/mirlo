...
1. **Shipped**: Publicly listed and discoverable in Chrome Web Store
2. **Used**: 100+ installs within 3 months of public launch
3. **Documented**: A digital garden seed about what we learned shipping it
4. **Repeatable**: The build/ship/promote process is documented well enough to reuse on the next project

## Operating Stance

- **Ship first.** A shipped imperfect thing beats an unshipped perfect thing.
- **Lean startup.** Don't polish what nobody has tried yet. Get it public, then iterate on real feedback.
- **Automate what repeats.** If you do something twice, script it the third time.
- **Privacy is non-negotiable.** No external APIs, no tracking, no data collection. Ever.

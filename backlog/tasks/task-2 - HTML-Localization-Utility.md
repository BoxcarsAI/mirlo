...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 A reusable function/module exists (e.g., in a shared utility file or as a snippet)
- [ ] #2 The utility finds elements with data-i18n attributes
- [ ] #3 The utility sets the innerText (or appropriate property) using chrome.i18n.getMessage
- [ ] #4 The utility handles different target attributes if necessary (e.g., placeholder, title)
<!-- AC:END -->
